...
//                 className="w-full px-3 py-2 border rounded-md focus:ring-orange-300 focus:outline-none"
...
//             </div>
//             <div>
//               <label className="block text-gray-700 mb-1">Opportunity Owner</label>
//               <input
//                 type="text"
//                 name="opportunityOwner"
//                 value={formData.opportunityOwner}
//                 onChange={handleChange}
//                 className="w-full px-3 py-2 border rounded-md focus:ring-orange-300 focus:outline-none"
...
//             </div>
//             <div>
//               <label className="block text-gray-700 mb-1">Expected Closing Date</label>
//               <input
//                 type="date"
...
//             </div>
//             <div>
//               <label className="block text-gray-700 mb-1">Probability (%)</label>
//               <input
//                 type="number"
//                 name="probability"
