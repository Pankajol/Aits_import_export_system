  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(res => {
        ...
        setSelectedBomId(o.bomId ? o.bomId : o.bomId.productNo);
        setType(o.type);
        setStatus(o.status);
        // setWarehouse(o.warehouse);
        setWarehouse(o.warehouse._id ? o.warehouse._id : o.warehouse);
        ...
        setBomItems(
          o.items.map(it => ({
            ...
            warehouse: it.warehouse._id ? it.warehouse._id : it.warehouseName,
          }))
        );
      })
      .catch(console.error);
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow rounded">
      <h2 className="text-2xl font-semibold mb-4">
        ...
        <div>
          ...
          >
            <option value={selectedBomId}>-- choose --</option>
            {boms.map(b => (
