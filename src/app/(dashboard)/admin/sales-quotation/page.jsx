// components/SalesQuotationForm.js
"use client";
...
export default function SalesQuotationForm() {
  ...
  return (
    <div className="p-10 m-20 bg-gray-100  rounded-lg shadow-2xl ">
      <h1 className="text-xl font-bold mb-4">Sales Quotation</h1>
...
//     refNumber: "",
//     items: [
//       { itemType: "", itemName: "", quantity: 0, unitPrice: 0, discount: 0, gst: 0, totalAmount: 0 }
//     ],
//     salesEmployee: "",
//     remarks: "",
//     freight: 0,
...
//           <input type="text" placeholder="Item Type" className="p-2 border rounded" />
//           <input type="text" placeholder="Item Name" className="p-2 border rounded" />
//           <input type="number" placeholder="Quantity" className="p-2 border rounded" />
//           <input type="number" placeholder="Unit Price" className="p-2 border rounded" />
//           <input type="number" placeholder="Discount (%)" className="p-2 border rounded" />
//           <input type="number" placeholder="GST (%)" className="p-2 border rounded" />
//         </div>
//       ))}
//       <button
//         onClick={addItemRow}
...
//       <button className="mt-6 p-2 bg-green-500 text-white rounded hover:bg-green-600">
//         Submit
//       </button>
//     </div>
//   );
